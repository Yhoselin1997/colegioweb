          ...
          <div className={not.containerN}>
            ...
            <div className={not.detailsN}>
              ...
              <p className={not.contentN}>
                {item.content}<br />
                {item.nomEnlace1}
                <a href={item.enlace1} target="_blank" rel="noreferrer">{item.enlace1}</a><br />
                {item.nomEnlace2}
                <a href={item.enlace2} target="_blank" rel="noreferrer">{item.enlace2}</a><br />
                {item.nomEnlace3}
                <a href={item.enlace3} target="_blank" rel="noreferrer">{item.enlace3}</a>
              </p>
