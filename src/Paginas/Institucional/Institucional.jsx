  ...
  return (
    <Layout>
      ...
      <div>   
              ...
              <Container>
                <h1 className={c.titleBlue} ref={historiaRef}>Historia</h1><br/>
                  <p className={c.textBlue}>
                    El año de 1975, la entonces Fuerza Naval Boliviana, 
                    realizó un estudio de localización y ubicación para la Escuela Naval Militar, 
                    existiendo diferentes ideas y sugerencias. Finalmente el 23 de abril de 1976, 
                    se efectuó el traslado de los Cadetes de la Fuerza Naval Boliviana, 
                    al mando del Cap. Frag. Tomás Orozco Saracho, a las instalaciones de la 
                    Ex Estación de Ferrocarriles La Paz-Guaqui, después de que el Ministerio de Educación y el
                    Ministerio de Transportes y Comunicaciones, por parte del Estado, 
                    tomarán la decisión de ceder mencionados predios a la Fuerza Naval Boliviana 
                    mediante Decreto Supremo N° 16299 de fecha 22 de marzo de 1979.
                    
                    El 31 de enero de 2002, se promulga Ley Nº 2324, 
                    la misma que otorga la propiedad del inmueble y terrenos de la 
                    Ex Estación de Ferrocarriles La Paz-Guaqui a la Escuela Naval Militar,
                    con el único artículo que señala: 
                    ...
                    con una superficie de 26.791 metros cuadrados, ubicado dentro de la 
                    Ex Estación Ferroviaria La Paz–Guaqui de esta ciudad, a favor de la Fuerza Naval Boliviana, 
                    para la instalación y funcionamiento de la Escuela Naval Militar, 
                    dispuesta mediante Resolución Municipal Nº 1216 de 20 de junio de 1979” y 
                    posteriormente el 14 de marzo de 2002, el Presidente de la Honorable Cámara de 
                    Senadores de ese entonces Dr. Enrique Toro Tejada, a nombre del Honorable Congreso Nacional, 
                    realizó la entrega oficial de la mencionada Ley.
                    ...
                    por el Ministerio de Educación y la Resolución Administrativa de la Armada Boliviana 025/2014, 
                    se aprueba la apertura y legal funcionamiento de la UNIDAD EDUCATIVA PRIVADA NAVAL “HÉROES DEL PACÍFICO”,
                    dando inicio a las actividades educativas en los niveles de Educación Inicial, Primaria y Secundaria, 
                    para así participar activamente en el desarrollo de la Educación Nacional.
                  </p>
                </Container>
            </div>
            <div className={c.contentWhite}>
            ...
            <div className={c.contentBlue}>
            <Container>
              <h3 className={c.titlePInst} ref={politicaInstRef}>Política institucional</h3>
              <p className={c.textBlue}>sin contenido</p>
